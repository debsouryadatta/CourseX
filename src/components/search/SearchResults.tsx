...
import { CourseWithUser, Profile } from "./Search";
import { IconSearch } from "@tabler/icons-react";
import { useRouter } from "next/navigation";

export default function SearchResults({courses, profiles}: {courses?: CourseWithUser[], profiles?: Profile[]}) {
            ...
            <div className="flex gap-4 flex-row ">
              <motion.div layoutId={`image-${course.title}-${id}`}>
                <Image
                  ...
                  src={course.image}
                  alt={course.title}
                  className="h-14 w-14 md:h-14 md:w-14 rounded-lg object-cover object-top"
                />
              </motion.div>
              <div className="">
                <motion.h3
                ...
                <motion.p
                  layoutId={`description-${course.userId}-${index}`}
